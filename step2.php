                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="header__wrapper">
                                ...
                                <a class="logo" href="/"><img src="img/logo-1.svg" alt="logo"></a>
                                <div class="menu">
                                    <ul class="menu-list">
                                        <li class="menu__item">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="steps__form steps__form2">
                            <h2 id="step2-h2">ОПЛАТА ЗАЯВКИ №16046486</h2>

                            <h2 id="step3-h2" class="disable">ПРОВЕРКА ОПЛАТЫ №16046486</h2>

                            <h2 id="step4-h2" class="disable">ОШИБКА ЗАЯВКИ №16046486</h2>
