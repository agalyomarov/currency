...
<head>
    ...
    <meta name="csrf-token" content="Tx0warJfxaJUALKhszUBPD2XZhaR3P7Mw-GzhLhCotU1V0MtwxaU-hlh4eWLb0dYSuc-eMWZnP-vjOT12wXBgA==">
        ...
        <div class="content">
                        ...
                        <div class="col-md-12">
                            <div class="header__wrapper">
                                ...
                                <div class="menu">
                                    <ul class="menu-list">
                                        <li class="menu__item">
                                            <a class="menu__link" href="questions.php">Вопросы и ответы</a>
                                        </li>
                                    ...
                                    <div class="mobile-lang">
                                        <div class="dropdown dropdown-languages">
                                            ...
                                            <ul id="w0" class="dropdown-menu">
                                                <li><a href="contacts.html" tabindex="-1">ru</a></li>
                                                <li><a href="../en/site/contacts.php" tabindex="-1">en</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="lang">
                                    <div class="dropdown dropdown-languages">
                                        ...
                                        <ul id="w1" class="dropdown-menu">
                                            <li><a href="contacts.php" tabindex="-1">ru</a></li>
                                            <li><a href="../en/site/contacts.php" tabindex="-1">en</a></li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="page">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page__h1">Контакты сервиса</h1>
                        </div>
                    </div>
                            ...
                            <div class="contacts">
                                <ul class="contacts-list">
                                    <li class="contact-item">
                                        <a class="contact-link" href="https://t.me/i2fed" target="_blank">
                                ...
                                <div class="contact-note">
                                    Если что-то пошло не так, для большей оперативности напишите нам в telegram, кнопка для связи в верхней правой части экрана. Наши специалисты с радостью ответят на любые Ваши вопросы. </div>
                            </div>
                        </div>
